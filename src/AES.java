...
public class AES {
	...
	public static void main(String[] args) throws Exception {
		AES aes = new AES();
//		byte[] temp = aes.hexStringToByteArray("EA04658583455D965C3398B0F02DADC5");
//		//aes.printBytes(temp);
//		System.out.println("Before Sub-bytes: " + bytesToHex(temp));
//		byte[] out = aes.subBytes(temp);
//		System.out.println("After Sub-bytes: " + bytesToHex(out));
//		temp = aes.inverseSubBytes(out);
//		System.out.println("After Inverse Sub-bytes: " + bytesToHex(temp));
//		//aes.printBytes(out);
//		System.out.println("Before Shift: " + bytesToHex(out));
//		temp = aes.shiftRows(out);
//		System.out.println("After Shift: " + bytesToHex(temp));
//		out = aes.inverseShiftRows(temp);
//		System.out.println("After Inverse Shift: " + bytesToHex(out));
//		out = aes.mixColumns(temp);
//		System.out.println(bytesToHex(out));
//		temp = aes.inverseMixColumns(out);
//		System.out.println(bytesToHex(temp));
//		byte[] key = aes.hexStringToByteArray("0f1571c947d9e8590cb7add6af7f6798");
//		byte[] keyWords = aes.expandKey(key);
//		System.out.println(bytesToHex(keyWords));		
		...
		key = aes.hexStringToByteArray("0e1571c947d9e8590cb7add6af7f6798");
		cipher = aes.encrypt(plainText, key);
		System.out.println("CIPHER TEXT USING ANOTHER KEY: " + bytesToHex(cipher));
	}
}